...
\section{Leading Principles and Revised Rules for the Lutheran Free Church}

\subsection{Leading Principles}
...
\pagebreak
\subsection{The Revised Rules for Work}\footnote{
...
3. This purpose is sought to be attained chiefly by the holding of larger and smaller meetings, by the dissemination of suitable literature, by the organization of free-church committees and associations, by the sending out of emissaries, and by other means which from time to time may show themselves expedient.

4. The Free Church consists of Lutheran congregations which by resolution acknowledge its principles and rules and report the same to the Secretary, regardless of other denominational connection.

5. The Free Church holds an annual meeting, which as a rule begins on the first Wednesday of the month of June, and which elects the necessary committees, emissaries, and office-bearers, and determines which ecclesiastical tasks the meeting will especially recommend to the congregations. 

FIXME: add the remaining old defs.
